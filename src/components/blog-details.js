...
import blogDetailsImage from '../assets/img/blog/details/blog-details.jpg';
import blogAuthorImage from '../assets/img/blog/details/blog-author.jpg';
                    ...
                    <div className="row d-flex justify-content-center">
                        <div className="col-lg-12">
                            <div className="blog__details__pic">
                                <img src={blogDetailsImage} alt="Blog Details" />
                            </div>
                        </div>
                                        ...
                                        <div className="col-lg-6 col-md-6 col-sm-6">
                                            <div className="blog__details__author">
                                                <div className="blog__details__author__pic">
                                                    <img src={blogAuthorImage} alt="Blog Author" />
                                                </div>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-6 col-md-6 col-sm-6">
                                            <a href="#" className="blog__details__btns__item">
                                                <p><span className="arrow_left"></span> Previous Post</p>
                                                <h5>It S Classified How To Utilize Free Classified Ad Sites</h5>
                                            </a>
                                        </div>
                                        <div className="col-lg-6 col-md-6 col-sm-6">
                                            <a href="#" className="blog__details__btns__item blog__details__btns__item--next">
                                                <p>Next Post <span className="arrow_right"></span></p>
